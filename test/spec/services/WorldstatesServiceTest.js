...
describe('WorldstatesServiceTest', function () {
    var Worldstates, ws, ws2, ws3;
    ...
    it('should strip icc data', function() {
        var vec;

        vec = Worldstates.utils.stripIccData(ws);
        expect(vec).toEqual([{
                name: 'Ski-Weltmeisterschaften Garmisch-Partenkirchen 1',
                data: {tobe: 'done'}
            }]);

        vec = Worldstates.utils.stripIccData(ws2, false);
        expect(vec).toEqual([{
                name: 'Ski-Weltmeisterschaften Garmisch-Partenkirchen 1',
                data: {tobe: 'done'}
            },
        ...
        vec = Worldstates.utils.stripIccData(ws2, true);
        expect(vec).toEqual([{
                name: 'Ski-Weltmeisterschaften Garmisch-Partenkirchen 1',
                data: {tobe: 'done3'}
            },
        ...
        vec = Worldstates.utils.stripIccData(ws3, false);
